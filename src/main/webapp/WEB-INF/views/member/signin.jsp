...
/*    background-image: url("https://www.shutterstock.com/ko/image-photo/software-source-code-programming-on-computer-634574354"); */
...
<!-- 			        </div> -->
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="/member/signin.do" name="signinInfo" method="post" onSubmit="return id_pw_check()">
						                    <input type="text" name="userId" id="userId" class="inpt" required="required" placeholder="Your email">
						                    <label for="email">Your id</label>
						                    <input type="password" name="userPass" id="userPass" class="inpt" required="required" placeholder="Your password">
...
<!-- 						                    <input type="text" name="email" id="name" class="inpt" required="required" placeholder="Your name4"> -->
<!-- 						                    <label for="name">Your name</label> -->
<!--                     <input type="email" name="email" id="email" class="inpt" required="required" placeholder="Your email5"> -->
<!-- 						                    <label for="email">Your email</label> -->
<!-- 						                    <input type="password" name="password" id="password" class="inpt" required="required" placeholder="Your password6"> -->
<!--                 						    <label for="password">Your password</label> -->
<!-- 						                    <div class="submit-wrap"> -->
...
function id_pw_check() {
    ...
    if(id.length == 0) {
        ...
        document.signinInfo.userId.focus();
        return false;
    }
    if(pw.length == 0) {

        alert("비밀번호를 입력해주세요");
        document.signinInfo.userPass.focus();
        return false;
    }
    return true;
}
